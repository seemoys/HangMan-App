  ...
  return (
    <div className="flex flex-col  mb-5 gap-3">
      ...
      <input
        ...
        className="px-20 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition text-center"
      />
